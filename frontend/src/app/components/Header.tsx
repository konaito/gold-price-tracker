...
export default function Header() {
  ...
  const navItems = [
    { href: '/', label: '金価格 (JPY/g)', shortLabel: 'JPY', symbol: 'jpygold' },
    { href: '/gold', label: '金価格 (USD/oz)', shortLabel: 'USD', symbol: 'gold' },
    { href: '/usdjpy', label: 'ドル円', shortLabel: 'USD/JPY', symbol: 'usdjpy' },
  ];
